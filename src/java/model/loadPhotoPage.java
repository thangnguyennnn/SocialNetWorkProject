...
public class loadPhotoPage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Attachment> photos = d.getAllPhoto(u.getUserId());
        
        request.setAttribute("sizePhoto", photos.size());
        request.setAttribute("photos", photos);
        request.setAttribute("idPage", 4);
