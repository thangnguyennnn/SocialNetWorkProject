...
<html lang="en">
    ...
    <body>
                                ...
                                <div class="col-lg-12">
                                    <div class="prod-detail">
                                        ...
                                        <c:if test="${dD.nickName != '' && dD.nickName != null}">
                                            <span style="margin-bottom: 35px;" class="title2">Hồ sơ hẹn hò của <ins style="text-decoration: none; color: #fb6342;">${dD.nickName}</ins>:</span>
                                        </c:if>
                                        <c:if test="${dD.nickName == '' || dD.nickName == null}">
                                            <span style="margin-bottom: 35px;" class="title2">Hồ sơ hẹn hò của <ins style="text-decoration: none; color: #fb6342;">${dD.name}</ins>:</span>
                                        </c:if>
                                                ...
                                                <div class="right-detailmeta" style="padding-left: 13%;">
                                                    ...
                                                    <ul id="statusDating">
                                                        <c:if test="${status == null || status == '0'}">
                                                            <li onclick="likeDatingTarget('${dD.userID}'); notificateDating('${dD.userID}');"><div title="Bày tỏ" class="likes heart">❤</div></li>
                                                            </c:if>
                                                            <c:if test="${status == '1'}">
                                                            <li class="share-pst"><div title="Hủy bỏ" class="likes heart happy">❤</div></li>
                                                            </c:if>
                                                    </ul>
                                                </div>
                                                <br><br>
                                    ...
                                    <div class="central-meta">
                                        <span class="title2">Gợi ý khác:</span>
                                        <div class="row remove-ext">
                                            <c:forEach items="${listA}" var="o">
                                                <c:if test="${o.userID != dD.userID && o.userID != AccLogin.userId}">
            ...
            <div class="popup">
                ...
                <div class="popup-meta">
                    <div class="popup-head">
                        <c:if test="${dD.nickName != '' && dD.nickName != null}">
                            <h5>Hủy mối nhân duyên với <ins style="text-decoration: none; color: #fb6342;">${dD.nickName}</ins></h5>
                            </c:if>
                            <c:if test="${dD.nickName == '' || dD.nickName == null}">
                            <h5>Hủy mối nhân duyên với <ins style="text-decoration: none; color: #fb6342;">${dD.name}</ins></h5>
                            </c:if>
                    </div>
                    <div class="Rpt-meta">
                        <span>Chúng tôi rất tiếc về điều này, 2 bạn vẫn sẽ có thể gặp lại trên Tóp Tóp</span>
                        <br><br>
                        <form action="dislikeDatingTarget?targetID=${dD.userID}" method="post" class="c-form">
                            <div>
                                <button data-ripple="" type="submit" class="main-btn">Bỏ thích</button>
        ...
        <script>
                                                                ...
                                                                function likeDatingTarget(param) {
                                                                    var userID = param;
                                                                    $.ajax({
                                                                        url: "likeDatingTarget",
                                                                        type: "post",
                                                                        data: {
                                                                            userid: userID,
                                                                        },
                                                                        success: function (data) {
                                                                            var liStatus = document.getElementById("statusDating");
                                                                ...
                                                                function notificateDating(param) {
                                                                    var userID = param;
                                                                    $.ajax({
                                                                        url: "notificateDating",
                                                                        type: "post",
                                                                        data: {
                                                                            userid: userID,
                                                                        },
                                                                        success: function (data) {
                                                                            var liStatus = document.getElementById("notiDating");
                                                                            liStatus.innerHTML = data;
                                                                        },
                                                                        error: function (xhr) {
