                                ...
                                <div class="col-lg-12">
                                                ...
                                                <div class="widget">
                                                    ...
                                                    <div class="page-likes">
                                                        <ul class="nav nav-tabs likes-btn">
                                                            <li class="nav-item"><a class="active" href="#link1" data-toggle="tab" data-ripple="">Người theo dõi</a></li>
                                                            <li class="nav-item"><a class="" href="#link2" data-toggle="tab" data-ripple="">Đang theo dõi</a></li>
                                                        </ul>
                                                        <!-- Tab panes -->
                                    ...
                                    <div class="col-lg-6">
                                        <div class="central-meta postbox">
                                            <span class="create-post">Viết lên dòng thời gian của ${GInfor.lastName} ${GInfor.middleName} ${GInfor.firstName}</span>
                                                ...
                                                <div class="newpst-input">
                                                    <div class="newpst-input">
                                                        <form action="addPost" method="post" enctype="multipart/form-data">
                                                            <textarea oninput="validate2(this)" name="contentPost" rows="2" placeholder="Chia sẻ những suy nghĩ của bạn?"></textarea>
                                                                        ...
                                                                        <div class="more-post-optns"><i class="ti-more-alt"></i>
                                                                            <ul>
                                                                                <c:if test="${p.userID == AccLogin.userId}">
                                                                                    <li class="edit-post" ><i class="fa fa-pencil-square-o"></i>Sửa bài viết</li>
                ...
                <div class="popup-meta">
                    ...
                    <div class="newpst-input">
                        <form action="addPost" method="post" enctype="multipart/form-data">
                            ...
                            <button style="width: 100%" class="post-btn" type="submit" data-ripple="">Sửa</button>
                        </form>
                    </div>
                </div>	
            </div>
